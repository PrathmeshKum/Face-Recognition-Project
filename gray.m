...
% for iFile = 1:20;
%     
%     vIm=reshape(test_matrix(:,iFile),[40 30 1]);
%     subplot(2,ceil(20),iFile);
%     showIm=vIm;
%     imshow(showIm);
%     %title(' Test Face ');
%     num=matched_matrix(iFile,1);
%     vIm1=reshape(train_matrix(:,num),[40 30 1]);
